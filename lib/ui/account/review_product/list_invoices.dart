...
class _ListInvoicesPageState extends State<ListInvoicesPage> {
  ...
  void initState() {
    ...
    _orderListProductBloc.add(GetOrderList(sessionId: SESSION_ID, status: 'completed', skip: _apiPage.toString(), limit: LIMIT_PAGE.toString(), apiToken: apiToken));
              ...
              builder: (context, state) {
                if(state is OrderListError) {
                  ...
                  if(_lastData && _apiPage==0){
                    return Container(
                        child: Center(
                            child: Text(AppLocalizations.of(context)!.translate('no_invoices_list')!, style: TextStyle(
                                fontSize: 14,
                                color: BLACK_GREY
                            ))
                        )
        ...
        child: Container(
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => InvoiceDetailPage(invoices: orderListData[index].invoice)));
                },
                child: Container(
              ...
              Container(
                  ...
                  child: GestureDetector(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(AppLocalizations.of(context)!.translate('review')!, style: TextStyle(
                            color: PRIMARY_COLOR
                        )),
