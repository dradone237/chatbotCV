...
class _SetAddressPageState extends State<SetAddressPage> {
                  ...
                  child: Row(
                    ...
                    children: [
                      addressData[index].defaultAddress==false?GestureDetector(
                        ...
                        child: Text(AppLocalizations.of(context)!.translate('make_default')!, style: GlobalStyle.addressAction),
                      ):Wrap(),
                      index!=0?SizedBox(
                        width: 12,
                      ):Wrap(),
                      GestureDetector(
                        ...
                        child: Text(AppLocalizations.of(context)!.translate('edit')!, style: GlobalStyle.addressAction),
                      ),
                      SizedBox(
                        width: 12,
                      ),
                      GestureDetector(
                        ...
                        child: Text(AppLocalizations.of(context)!.translate('delete')!, style: GlobalStyle.addressAction),
                      ),
                    ],
                  )
              )
  ...
  void _showPopupDeleteAddress(int index) {
    ...
    Widget continueButton = TextButton(
        onPressed: () {
          Navigator.pop(context);
          if(index==0){
            Fluttertoast.showToast(msg: AppLocalizations.of(context)!.translate('delete_address_message')!, toastLength: Toast.LENGTH_LONG);
          } else {
            setState(() {
    ...
    AlertDialog alert = AlertDialog(
      ...
      title: Text(AppLocalizations.of(context)!.translate('delete_address')!, style: TextStyle(fontSize: 18),),
      content: Text(AppLocalizations.of(context)!.translate('delete_address_message2')!, style: TextStyle(fontSize: 13, color: BLACK_GREY)),
      actions: [
        cancelButton,
        continueButton,
      ],
  ...
  void _showPopupMakeDefault() {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text(AppLocalizations.of(context)!.translate('make_default_message')!, style: TextStyle(fontSize: 13, color: BLACK_GREY)),
      actions: [
        cancelButton,
        continueButton,
      ],
